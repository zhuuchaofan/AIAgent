...
- UI still exposes technical detail under a collapsible section because the
  release is still gated and needs audit visibility.
...
3. Remove or hide compatibility demo routes after dependent tests and docs are
   updated.
