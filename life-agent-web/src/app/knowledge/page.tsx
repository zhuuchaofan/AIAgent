      ...
      <div className="mx-auto max-w-5xl">
        <header className="mb-8 flex items-center justify-between gap-4 border-b border-zinc-800/50 pb-5">
          <div>
            ...
            <h1 className="text-2xl font-semibold text-zinc-100">资料库</h1>
            <p className="mt-1 text-sm text-zinc-500">管理用于问答的个人资料。</p>
          </div>
        </header>

        {!user ? (
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-6 text-center">
            <p className="text-sm text-zinc-500">请先登录，再管理资料库。</p>
            <button
